-- Adiciona coluna cpf_cnpj em galeria_visitantes (para galerias sem cliente_id)
ALTER TABLE public.galeria_visitantes ADD COLUMN IF NOT EXISTS cpf_cnpj text;

-- Atualiza a RPC upsert_visitor_contact para também gravar cpf_cnpj no visitante
