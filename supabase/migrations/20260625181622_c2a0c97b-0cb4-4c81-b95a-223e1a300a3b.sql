-- 1. Adicionar colunas faltantes em galeria_acoes
ALTER TABLE public.galeria_acoes
  ADD COLUMN IF NOT EXISTS payload JSONB,
  ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ;

-- 2. Ampliar CHECK do tipo para reconhecer eventos de arquivamento
ALTER TABLE public.galeria_acoes DROP CONSTRAINT IF EXISTS galeria_acoes_tipo_check;
ALTER TABLE public.galeria_acoes ADD CONSTRAINT galeria_acoes_tipo_check
  CHECK (tipo IN (
    ...
    'galeria_excluida','gallery_archived','gallery_archived_partial'
  ));

-- 3. Reescrever archive_gallery preenchendo user_id e payload rico
...
BEGIN
  ...
  INSERT INTO public.galeria_acoes (galeria_id, user_id, tipo, descricao, payload)
  VALUES (
    p_gallery_id, v_user_id, 'gallery_archived',
